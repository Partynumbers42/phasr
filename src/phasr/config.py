...
class paths():
    # 
    def __init__(self,cross_section_data_path,barrett_moment_data_path,spline_path,energy_path,fit_path,best_fit_path,correlation_quantities_paths):
...
local_paths=paths(default_cross_section_data_path,default_barrett_moment_data_path,default_spline_path,default_energy_path,default_fit_path,default_best_fit_path,default_correlation_quantities_path)